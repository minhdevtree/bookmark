...
export function DeleteColumnDialog({ column }: { column: Column }) {
  const { cols, tasks, updateCols, updateTasks } = useTask();
  ...
  const handleDeleteColumn = async () => {
    ...
    updateTasks(tasks.filter((task: any) => task.columnId !== deleteColumn.id));
    updateCols(cols.filter((col: any) => col.id !== deleteColumn.id));
